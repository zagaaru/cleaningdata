...
##Reads in data and filter the date 


fh <- fread("./exploredata/household_power_consumption.txt", na.strings="?",stringsAsFactors = FALSE)
pwrcons <- filter(fh, grep("^[1,2]/2/2007", Date))

##Convert global active power column,
##global reactive power colums, 
##Sub_metering columns,
##Voltage column to numeric
...
##Add new column that combines date and time data 
